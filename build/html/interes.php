...
<html>
  <head>
    ...
    <title>Therappy - De tu interés</title>
    ...
    <header>
      ...
      <section class="menu-bar">
        <ul class="list-content">
          ...
          <a href="interes.php"><li class="list-item selected"><span  class="hvr-bob selected">De tu interés</span></li></a>
      ...
      <span class="nav-icon">&#9776;</span>
        <ul class="mobile-nav animated">
          ...
          <a href="interes.php"><li class="selected">De tu interés</li></a>
...
<!-- Banner  -->
    <section class="banner">
      <div class="banner-image">
        <img src="../img/banner-capacitacion-01.png" >
      </div>
    </section>
